...
def gather(previous_location): 
    ...
    while keep_gather == "option_1":
        if gather_choice == "stick":
            ...
            if correct_option == "option 1":
                ...
                if stick_pickup == "option 1":
                    ...
                    if inventory.count("stick") == 1:
                        ...
                        stick_amount = inventory.count("stick")
                        rp(f"You Have {stick_amount} In Your Inventory", 1)
                ...
                if stick_pickup == "option 1":
                    ...
                    if inventory.count("stick") == 1:
                        ...
                        stick_amount = inventory.count("stick")
                        rp(f"You Have {stick_amount} Sticks", 1, True)
            ...
            honey_amount = inventory.count("honeycomb")
            rp(f"You Now Have {honey_amount} In Your Inventory", 1, True)
